...
main(int argc, char ** argv)
{
    ...
    {
        PixelType pixel1 = it.GetPixel(offset1);
        PixelType pixel2 = it.GetPixel(offset2);
        PixelType pixel3 = it.GetPixel(offset3);
        PixelType pixel4 = it.GetPixel(offset4);
        PixelType pixel5 = it.GetPixel(offset5);
        PixelType pixel6 = it.GetPixel(offset6);
        PixelType pixel7 = it.GetPixel(offset7);
        PixelType pixel8 = it.GetPixel(offset8);

        PixelType median = getMedian(pixel1, pixel2, pixel3, pixel4, pixel5, pixel6, pixel7, pixel8);
